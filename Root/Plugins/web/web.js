                ...
                categoryOptionsList: [
                    {
                        ...
                        getActualSet: async ({ guild }) => {
                            return setting[guild.id].langsSettings || null;
                        },
                        setNew: async ({ guild, newData }) => {
                            setting[guild.id].langsSettings = newData;
                            return;
                        }
                    },
                ]
                ...
                categoryOptionsList: [
                    {
                        ...
                        getActualSet: async ({ guild }) => {
                            return setting[guild.id].join_msg || null;
                        },
                        setNew: async ({ guild, newData }) => {
                            setting[guild.id].join_msg = newData;
                            return;
                        }
                    },
                    {
                        ...
                        getActualSet: async ({ guild }) => {
                            return setting[guild.id].leave_msg || null;
                        },
                        setNew: async ({ guild, newData }) => {
                            setting[guild.id].leave_msg = newData;
                            return;
                        }
                    },
                ]
