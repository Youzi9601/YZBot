    ...
    ((e) => {
        (e[i] = (e) => {
            if (x(e)) {
                ...
                if ((t !== 4 && t !== 7) || e[0] !== "#") {
                    if ((t === 5 || t === 9) && e[0] === "#" && /^#([a-f\d]{3,4}){1,2}$/i.test(e))
                        return t === 5 ? [O(e[1] + e[1], 16), O(e[2] + e[2], 16), O(e[3] + e[3], 16), O(e[4] + e[4], 16) / 255] : [O(e[1] + e[2], 16), O(e[3] + e[4], 16), O(e[5] + e[6], 16), O(e[7] + e[8], 16) / 255];
                } else if (/^#([a-f\d]{3}){1,2}$/i.test(e)) return t === 4 ? [O(e[1] + e[1], 16), O(e[2] + e[2], 16), O(e[3] + e[3], 16), 1] : [O(e[1] + e[2], 16), O(e[3] + e[4], 16), O(e[5] + e[6], 16), 1];
                return [0, 0, 0, 1];
            }
            ...
            !(function i(y, x) {
                ...
                (B = (t) => {
                    let i = P(e),
                        ...
                        v = d[0] + a[0],
                        b = d[1] + a[1] + P(n)[1];
                    if (typeof t == "object") w(t[0]) && (v = t[0]), w(t[1]) && (b = t[1]);
                    else {
                        let e = a[0],
                            t = a[1],
                            n = a[0] + i[0] - p - f,
